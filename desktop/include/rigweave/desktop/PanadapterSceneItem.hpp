...
class PanadapterSceneItem : public QQuickItem {
    ...
    Q_PROPERTY(QString receiverId READ receiverId WRITE setReceiverId NOTIFY receiverIdChanged)
    ...
    Q_PROPERTY(double spectrumRatio READ spectrumRatio WRITE setSpectrumRatio NOTIFY viewChanged)
    Q_PROPERTY(QString rendererHealth READ rendererHealth NOTIFY rendererHealthChanged)
public:
