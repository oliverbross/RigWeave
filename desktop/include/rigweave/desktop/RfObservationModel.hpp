...
public:
    enum Role { ObservationRole = Qt::UserRole + 1, IdRole, SourceRole, EvidenceRole,
                CallsignRole, BandRole, ModeRole, AgeRole, DistanceRole, BearingRole,
                PrecisionRole, FreshnessRole };
    ...
    static QVector<QVector<QPointF>> greatCircle(QPointF fromLonLat, QPointF toLonLat,
                                                 bool longPath = false, int points = 96);
...
private:
    ...
    QVariantMap m_filters{{"source", "All"}, {"band", "All"}, {"mode", "All"},
